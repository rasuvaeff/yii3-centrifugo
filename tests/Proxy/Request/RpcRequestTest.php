...
final class RpcRequestTest
{
    public function fromArrayMapsAllFields(): void
    {
        $req = RpcRequest::fromArray([
            'client' => 'c1',
            'transport' => 'websocket',
            'protocol' => 'json',
            'encoding' => 'json',
        ...
        Assert::same($req->method, 'getConfig');
        Assert::same($req->data, ['key' => 'x']);
    }
